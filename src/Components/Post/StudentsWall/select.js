export const technologies = ["Javascript","Typescript","Python","React","Redux","React Native","CSS","Angular","Tailwind","Laravel","Vue","Express JS","Php","SQL","PostgreSQL"];

export const idiomas = ["A0","A1","A2","B1","B2","C1","C2"];

export const DevType = ["Frontend", "Backend", "Fullstack"];

export const workModal = ["Presencial","Remoto"];

export const allCountries = ["Afghanistan", "Albania", "Algeria", "Andorra", "Angola", "Antarctica", "Antigua and Barbuda",
